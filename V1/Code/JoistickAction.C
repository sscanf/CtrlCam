...
**     Contents  :
**
**         GetVal - bool JoistickAction_GetVal(void);
**
**
...
/*
** ===================================================================
**     Method      :  JoistickAction_GetVal (bean BitIO)
**
**     Description :
...
*/
/*
bool JoistickAction_GetVal(void)

**  This method is implemented as a macro. See JoistickAction.h file.  **
